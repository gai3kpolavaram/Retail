...
public class OfferDAOImpl implements  OfferDAO{
    ...
    public long insertOffer(long merchantID, Offer offer) {
        Offer newOffer = new Offer(idCounter, offer.getName(), offer.getDescription(), merchantID, offer.getCurrency().getCurrencyCode(), offer.getOfferPrice());
